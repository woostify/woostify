...
wp.customize.controlConstructor['woostify-range-slider'] = wp.customize.Control.extend({
	...
	ready: function() {
		...
		jQuery( controlClass + ' .woostify-reset' ).on( 'click', function() {
		...
		jQuery( controlClass + ' .woostify-range-slider-control' ).each( function() {
			var _this = jQuery( this );
		...
		jQuery( controlClass + ' .woostify-device-controls > span' ).on( 'click', function( event ) {
			...
			jQuery( controlClass + ' .woostify-range-slider-areas label' ).each( function() {
				var _this = jQuery( this );
				if ( device == _this.attr( 'data-option' ) ) {
					_this.show();
					_this.siblings().hide();
