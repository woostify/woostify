...
if ( ! class_exists( 'Woostify_Font_Helpers' ) ) :
    ...
    class Woostify_Font_Helpers
    {
         ...
         */
        static public function woostify_get_google_font_category( $font, $key = '' ) {
        ...
        function woostify_add_to_font_customizer_list( $fonts ) {
            ...
            $all_fonts = self::woostify_get_all_google_fonts();
         ...
         */
        static public function woostify_get_all_google_fonts( $amount = 'all' ) {
