...
// color group.
$wp_customize->add_setting(
	'woostify_setting[sticky_footer_bar_color5]',
	array(
		'default'           => $defaults['sticky_footer_bar_color5'],
		'type'              => 'option',
		'sanitize_callback' => 'woostify_sanitize_rgba_color',
		'transport'         => 'postMessage',
	)
...
$wp_customize->add_setting(
	'woostify_setting[sticky_footer_bar_color6]',
	array(
		'default'           => $defaults['sticky_footer_bar_color6'],
		'type'              => 'option',
		'sanitize_callback' => 'woostify_sanitize_rgba_color',
		'transport'         => 'postMessage',
	)
