...
if ( ! function_exists( 'woostify_add_to_font_customizer_list' ) ) {
	...
	function woostify_add_to_font_customizer_list( $fonts ) {
		...
		if ( function_exists( 'woostify_secondary_nav_get_defaults' ) ) {
			...
			if ( ! array_key_exists( $secondary_nav_id, $select_fonts ) && ! in_array( $secondary_nav_settings[ 'font_secondary_navigation' ], Woostify_Font_Helpers::woostify_typography_default_fonts() ) ) {
