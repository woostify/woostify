...
$wp_customize->add_setting(
	'woostify_setting[mini_cart_context_tabs]',
	array(
...
$wp_customize->add_control(
	new Woostify_Tabs_Control(
		...
		array(
			...
			'settings' => 'woostify_setting[mini_cart_context_tabs]',
			'choices'  => array(
...
$wp_customize->add_setting(
	...
	array(
		'type'              => 'option',
		'default'           => $defaults['mini_cart_enable_progress_bar'],
...
$wp_customize->add_control(
	new Woostify_Switch_Control(
		...
		array(
			...
			'section'     => 'woostify_mini_cart',
			'settings'    => 'woostify_setting[mini_cart_enable_progress_bar]',
			'tab'         => 'general',
		)
	)
);
...
$wp_customize->add_setting(
	...
	array(
		'type'              => 'option',
		'default'           => $defaults['mini_cart_progress_bar_amount'],
...
$wp_customize->add_control(
	new Woostify_Customize_Control(
		...
		array(
			...
			'type'        => 'number',
			'section'     => 'woostify_mini_cart',
			'settings'    => 'woostify_setting[mini_cart_progress_bar_amount]',
			'tab'         => 'general',
		)
	)
);
...
$wp_customize->add_setting(
	...
	array(
		'type'              => 'option',
		'default'           => $defaults['mini_cart_progress_bar_initial_msg'],
...
$wp_customize->add_control(
	new Woostify_Customize_Control(
		...
		array(
			...
			'type'        => 'textarea',
			'section'     => 'woostify_mini_cart',
			'settings'    => 'woostify_setting[mini_cart_progress_bar_initial_msg]',
			'tab'         => 'general',
		)
	)
);
...
$wp_customize->add_setting(
	...
	array(
		'type'              => 'option',
		'default'           => $defaults['mini_cart_progress_bar_success_msg'],
		'sanitize_callback' => 'woostify_sanitize_raw_html',
	)
);
$wp_customize->add_control(
	new Woostify_Customize_Control(
		...
		array(
			...
			'type'        => 'textarea',
			'section'     => 'woostify_mini_cart',
			'settings'    => 'woostify_setting[mini_cart_progress_bar_success_msg]',
			'tab'         => 'general',
		)
	)
);
...
$wp_customize->add_setting(
	...
	array(
		'default'           => $defaults['mini_cart_progress_bar_color'],
...
$wp_customize->add_setting(
	...
	array(
		'default'           => $defaults['mini_cart_progress_bar_success_color'],
		'sanitize_callback' => 'woostify_sanitize_rgba_color',
		'type'              => 'option',
		'transport'         => 'postMessage',
	)
