			...
			<div class="dialog-search-content">
				...
				<div class="dialog-search-header">
					...
					<span class="dialog-search-close-icon">
						<?php Woostify_Icon::fetch_svg_icon( $close_icon ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
					</span>
				</div>
		...
		<div class="site-tools">
			...
			<?php if ( $options['header_search_icon'] ) { ?>
				<span class="tools-icon header-search-icon">
					<?php Woostify_Icon::fetch_svg_icon( $search_icon ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
				</span>
				<?php
			}
			...
			if ( woostify_is_woocommerce_activated() ) {
				...
				if ( $options['header_wishlist_icon'] && woostify_support_wishlist_plugin() ) {
					...
					<a href="<?php echo esc_url( woostify_wishlist_page_url() ); ?>" class="tools-icon header-wishlist-icon">
						<?php Woostify_Icon::fetch_svg_icon( $wishlist_icon ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
				...
				if ( $options['header_account_icon'] ) {
					...
					<div class="tools-icon my-account">
						<a href="<?php echo esc_url( get_permalink( $page_account_id ) ); ?>" class="tools-icon my-account-icon">
							<?php Woostify_Icon::fetch_svg_icon( $my_account_icon ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
						</a>
				...
				if ( $options['header_shop_cart_icon'] ) {
					...
					<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="tools-icon shopping-bag-button <?php echo esc_attr( $shop_bag_icon_class ); ?>">
						<?php Woostify_Icon::fetch_svg_icon( $shop_bag_icon ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
...
if ( ! function_exists( 'woostify_scroll_to_top' ) ) {
	...
	function woostify_scroll_to_top() {
		...
		<span id="scroll-to-top" class="scroll-to-top-position-<?php echo esc_attr( $position ); ?> scroll-to-top-show-<?php echo esc_attr( $display ); ?>" title="<?php esc_attr_e( 'Scroll To Top', 'woostify' ); ?>">
			<?php Woostify_Icon::fetch_svg_icon( $icon ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
		</span>
		<?php
	}
}
