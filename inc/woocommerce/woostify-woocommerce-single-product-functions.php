				...
				<div class="prev-product-navigation product-nav-item">
					<a class="product-nav-item-text" href="<?php echo esc_url( get_permalink( $prev_id ) ); ?>">
						<span class="product-nav-icon">
							<?php Woostify_Icon::fetch_svg_icon( $prev_icon ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
						</span>
			...
			?>
				<div class="next-product-navigation product-nav-item">
					<a class="product-nav-item-text" href="<?php echo esc_url( get_permalink( $next_id ) ); ?>">
						...
						<span class="product-nav-icon">
							<?php Woostify_Icon::fetch_svg_icon( $next_icon ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
						</span>
					</a>
					<div class="product-nav-item-content">
