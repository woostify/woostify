...
// Define constants.
define( 'WOOSTIFY_VERSION', '1.9.1' );
define( 'WOOSTIFY_PRO_MIN_VERSION', '1.5.6' );
...
if ( woostify_is_woocommerce_activated() ) {
	...
	require_once WOOSTIFY_THEME_DIR . 'inc/woocommerce/woostify-woocommerce-taxonomy-image-fields.php';
}
